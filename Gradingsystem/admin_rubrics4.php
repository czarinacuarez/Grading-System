...
if (isset($_POST['submit'])) {
  //Prevent Posting Blank Values
    ...
    $postQuery = "INSERT INTO groups3 (group_id) VALUES(?)";
    $postStmt = $conn->prepare($postQuery);
    $rc = $postStmt->bind_param('s', $sec);
    $postStmt->execute();
    if ($postStmt) {
      header("refresh:1; url=admin_rubrics4.php");
    } else {
    }
  }
  ...
  if (isset($_GET['delete'])) {
    ...
    $adn = "DELETE FROM  groups3 WHERE  group3_id = ?";
        ...
        <div class="container-fluid mt--7">
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                    ...
                                    <div class = "col">
                                    <h3 style = "text-align:center;">Best in Web Application Category Candidates</h3>
                                    </div>
            ...
            <div class="table-responsive">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                <?php $ret = "SELECT * FROM  groups3 INNER JOIN groups ON groups.group_id = groups3.group_id";
                                    $stmt = $conn->prepare($ret);
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    while ($aa = $res->fetch_object()) {
                                      ...
                                      $sql = "SELECT AVG(grades3.total_grade) AS average_value
                                      FROM groups3
                                      INNER JOIN grades3 ON grades3.group_id = groups3.group3_id
                                      WHERE groups3.group_id = '$aa->group_id'";  
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="admin_rubrics2.php?delete=<?php echo $aa->group3_id ?>">
                                            <button class="btn btn-sm btn-danger">
                                                <i class="fas fa-trash"></i>
                                                Delete
                                            </button>
                                            </a>
                                            <a href="grades3.php?view=<?php echo $aa->group3_id ?>">
