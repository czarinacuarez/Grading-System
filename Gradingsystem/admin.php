        ...
        <div class="container-fluid mt--7">
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                    ...
                                    <div class = "col">
                                    <h3 style = "text-align:center;">All Group Candidates</h3>
                                    </div>
            ...
            <div class="table-responsive">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <?php $ret = "SELECT *
FROM groups
LEFT JOIN grades ON groups.group_id = grades.group_id
ORDER BY (
    SELECT AVG(total_grade)
    FROM grades
    WHERE groups.group_id = grades.group_id
) DESC;";
                                    $stmt = $conn->prepare($ret);
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="admin.php?delete=<?php echo $aa->group_id  ?>">
                                            <button class="btn btn-sm btn-danger">
                                                <i class="fas fa-trash"></i>
                                                Delete
                                            </button>
                                            </a>
                                            <a href="update_group.php?update=<?php echo $aa->group_id  ?>">
                                            <button class="btn btn-sm btn-primary">
                                                <i class="fas fa-user-edit"></i>
                                                Update
                                            </button>
                                            </a>
                                            <a href="grades.php?view=<?php echo $aa->group_id  ?>">
