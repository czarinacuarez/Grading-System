                    ...
                    <div class="card">
                        ...
                        <?php
                                    ...
                                    while ($aa = $res->fetch_object()) {
                                        ...
                                        $sql = "SELECT AVG(grades5.percent) AS average_value
                                        FROM groups
                                        INNER JOIN grades5 ON grades5.group_id = groups.group_id
                        ...
                        <!-- Chart wrapper -->
                            ...
                            <?php
                            $sql = "SELECT CONCAT(user.firstname, ' ', user.lastname) AS name, grades5.percent FROM grades5 INNER JOIN user ON user.id = grades5.user_id
                            WHERE grades5.group_id = '$id'";
                            $result = mysqli_query($conn, $sql);
                            ...
                            $sql_count = "SELECT COUNT(*) as total_count FROM grades5  INNER JOIN user ON user.id = grades5.user_id
                            WHERE grades5.group_id = '$id'";
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Visual Appeal</th>
                                        <th scope="col">Layout</th>
                                        <th scope="col">Interactivity</th>
                                ...
                                <tbody>
                                  <?php
                                    $ret = "SELECT * FROM  grades5 INNER JOIN user ON grades5.user_id = user.id WHERE group_id = '$id'";
                                    $stmt = $conn->prepare($ret);
                                    $stmt->execute();
                                    $res = $stmt->get_result();
                                    while ($aa = $res->fetch_object()) {
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $aa->visual_appeal ?></td>
                                            <td><?php echo $aa->layout ?></td>
                                            <td><?php echo $aa->interactivity ?></td>
                                            <td><?php echo $aa->technology ?></td>
                                            <td><?php echo $aa->information ?></td>
