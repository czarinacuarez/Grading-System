          ...
          <div class="col">
            <div class="card shadow">
              ...
              <form method="POST">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addAdmin" value="Add Panelist" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
              </div>
...
<?php  if (isset($_POST['addAdmin'])) {
    ...
    if (empty($_POST["cfirst"]) || empty($_POST["clast"])  || empty($_POST['cusn']) || empty($_POST['pass']) ) {
      ...
      $pass = $_POST['pass'];
        ...
        <?php }else{
            $sql = "INSERT INTO user (username,firstname,lastname, password, type) VALUES ('$uname','$first','$last', '$pass', 'Panelist')";
