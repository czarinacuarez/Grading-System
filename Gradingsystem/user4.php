        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3>Best in Web Application Category Grade Rubrics</h3>
            </div>
            <div class="card-body">
            ...
            <?php endif; ?>
                        <?php
                      $ret = "SELECT * FROM groups3 INNER JOIN groups on groups3.group_id = groups.group_id ";
                ...
                <div class="form-row">
                  <div class="col">
                    ...
                    <option value=<?php echo $ri['group3_id'] ?>><?php echo $ri['group_name'] ?></option>
                    <?php }?>
                    </select>
                  </div>
                </div>
                ...
                <table class="table-wrapper">
                                ...
                                <tbody>
                                        ...
                                        <td><b>Functionality</b></td>
                                            <td>Assess the range of features and capabilities offered by the web app. Projects with a wide 
range of useful functions should score higher.</td>
                                        ...
                                        <td><b>User Interface</b></td>
                                            <td>Evaluate the design, layout, and overall aesthetics of the web application. Higher scores 
should go to projects with an intuitive and visually appealing interface</td>
                                            ...
                                            <td>Evaluate the web app's speed, responsiveness, and efficiency. Higher scores should go to apps with 
fast and smooth performance.</td>
                                        ...
                                        <tr>
                                        <td><b>Usability</b></td>
                                            <td>Consider how easy it is for users to navigate the web app, perform tasks, and access information. 
Projects with excellent usability should receive higher scores.
                                        ...
                                        <td><b>Innovation</b></td>
                                            <td>Assess the originality and creativity of the web app's concept or features. Higher scores 
should go to projects that introduce novel solutions.</td>
                                        ...
                                        <td><b>Compatibility</b></td>
                                            <td>Evaluate the web app's compatibility with different devices, operating systems, and screen sizes. 
Projects with wide compatibility should score higher.</td>
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="submitGrade4" value="Submit Grades" class="btn btn-success" id="submit-grades-button" value="">
                  </div>
                </div>
              </form>
            </div>
